...
public class UserActionLoggingAspect extends UserAuditAspect {
     ...
     */
    @Pointcut("execution(* io.ylab.tom13.coworkingservice.out.rest.controller.implementation.UserEditControllerSpring+.*(..)) || " +
              "execution(* io.ylab.tom13.coworkingservice.out.rest.controller.implementation.AuthorizationControllerSpring+.*(..))")
